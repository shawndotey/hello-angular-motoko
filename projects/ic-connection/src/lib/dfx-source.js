...
/***/ "./src/declarations/ic_main/ic_main.did.js":
/*!*************************************************!*\
  !*** ./src/declarations/ic_main/ic_main.did.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/ic_main/index.js":
/*!*******************************************!*\
  !*** ./src/declarations/ic_main/index.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "ic_main": () => (/* binding */ ic_main)
/* harmony export */ });
...
/* harmony import */ var _ic_main_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ic_main.did.js */ "./src/declarations/ic_main/ic_main.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic_main.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  const agent = new _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.HttpAgent({ ...options?.agentOptions });
  
  // Fetch root key for certificate validation during development
  if(true) agent.fetchRootKey();

  // Creates an actor with using the candid interface and the HttpAgent
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_ic_main_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the ic_main canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic_main.did.js")._SERVICE>}
 */
 const ic_main = createActor(canisterId);
...
"use strict";
/*!*****************************************!*\
  !*** ./src/ic_main_assets/src/index.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_ic_main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/ic_main */ "./src/declarations/ic_main/index.js");

ic_main = _declarations_ic_main__WEBPACK_IMPORTED_MODULE_0__.ic_main
